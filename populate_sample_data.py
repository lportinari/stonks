...
def create_sample_data():
    ...
    print(f"Ranking calculado para {updated_count} ações")
    
    ranked_stocks = ranking_service.get_top_stocks(limit=10)
    
    print("\nTop 10 ações por ranking:")
    for i, stock in enumerate(ranked_stocks, 1):
        print(f"{i:2d}. {stock.ticker} - Score: {stock.score_final:6.2f} - {stock.empresa} - Setor: {stock.setor}")
